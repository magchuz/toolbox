        ...
        function QueryKeyword(keyword)
        {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    {
                        var currents = CleanVal(retList[i].toString());
                        if(hashMapResults[currents] != 1)
                        {
                            hashMapResults[currents] = 1;
                            keywordsToDisplay[keywordsToDisplay.length] = CleanVal(retList[i].toString());
...
//credit to keywordshitter.com Thanks :D		